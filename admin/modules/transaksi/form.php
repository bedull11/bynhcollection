...
elseif ($_GET['form'] == 'edit') {
  if (isset($_GET['id_transaksi'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM transaksi WHERE id_transaksi='$_GET[id_transaksi]'")
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" method="POST" action="modules/transaksi/proses.php?act=edit" enctype="multipart/form-data">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <option value="<?= $data['kota']; ?>" selected>Tangerang</option>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="telepon" value="<?= $data['telepon']; ?>" autocomplete="off" required>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Total</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control rupiah" name="total" value="<?= $data['total']; ?>" onKeyPress="return goodchars(event,'0123456789',this)" autocomplete="off" required>
                </div>
              </div>
            </div><!-- /.box body -->
